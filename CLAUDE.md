...
8. **Finis** — Références, Stock, Études coloris (single `edit_etudes_coloris` key gates all writes, default closed — #1092), Tarifs (price simulator, `lib/pricing-ref-tarif.ts`, 46/46 legacy parity).

...
// Moved out to lib/finance-common.ts (2026-08-25) so TRM's tableau de bord can
// mount the SAME implementation against société 2 — see that file's header for
// why a router factory rather than a second route file. URLs are unchanged:
// mounting at '/' keeps /api/rapports/finance, /api/rapports/ca-clients, …
//
